...
TEST_CASES = [
    ...
    ("집밥 재료로 5일 저탄 메뉴", "recipe_search"),
    ("한국식 반찬 스타일 1주 플랜", "recipe_search"),
    ("비건 키토 가능한 2일 메뉴", "recipe_search"),
    ("냉장고 파먹기 기준으로 구성해줘", "recipe_search"),
    ("요리 초보도 가능한 3끼 추천", "recipe_search"),
